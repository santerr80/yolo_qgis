    ...
    def analyze(dataset_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if os.path.exists(yaml_path):
                ...
                result = SegmentationDatasetAnalyzer._analyze_yolo_format(dataset_path, yaml_path)
            elif os.path.exists(ndjson_path):
                # NDJSON формат
                result = SegmentationDatasetAnalyzer._analyze_ndjson_format(dataset_path, ndjson_path)
            else:
...
class SegmentationTrainer:
    ...
    def train(self, dataset_path: str, model_type: str = 'yolov8n-seg',
